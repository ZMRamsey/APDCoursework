...
/**
 * Implements railway systems.  A railway system consists of the tracks, with a shared pass, two railway companies
 * (Bolivia and Peru), some baskets for communication, and a clock to time limit execution.
 */
...
public class RailwaySystem {
	...
	public Railway getNextRailway(Railway railway) throws ProgrammingError {
		...
		if (index == -1) { // railway is not in the list
			throw new ProgrammingError(railway.getName() + " is not registered with this system");
		}
